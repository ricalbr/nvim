...
local lsp_keymaps = function(bufnr)
  ...
  vim.keymap.set('n', "<leader>pvd", "<cmd>Lspsaga peek_definition<CR>", { silent = true })
  ...
  -- vim.keymap.set('n', '<leader>lws', function() print(vim.inspect(vim.lsp.buf.list_workspace_folders())) end, bufopts)
